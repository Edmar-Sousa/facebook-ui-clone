        ...
        <svg viewBox="0 0 24 24" width="24px" height="24px">
            <g fillRule="evenodd" transform="translate(-444 -156)">
                <g>
                    ...
                    <path 
                        fill="#f3425f"
                        d="M98.75 12c1.379 0 2.5-1.121 2.5-2.5S100.129 7 98.75 7a2.503 2.503 0 0 0-2.5 2.5c0 1.379 1.121 2.5 2.5 2.5" transform="translate(354 158.5)"></path>
                </g>
            </g>
        </svg>
    )
...
export default CameraCreateIcon
